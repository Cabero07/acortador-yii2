...
class AdminOptions extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['adskeeper_code', 'ad_code_2', 'ad_code_3'], 'string'],
            [['adskeeper_code', 'ad_code_2', 'ad_code_3'], 'safe'], 
            [['click_tracking_enabled'], 'boolean'],
            [['own_click_earning', 'referral_click_earning' , 'exchange_rate_cup', 'exchange_rate_mlc'], 'number', 'min' => 0], 
        ];
    }
    ...
    public function save()
    {
        ...
        Yii::$app->settings->set('ad_code_2', $this->ad_code_2);
        Yii::$app->settings->set('ad_code_3', $this->ad_code_3);
    ...
    public function loadSettings()
    {
        ...
        $this->ad_code_2 = Yii::$app->settings->get('ad_code_2', '');
        $this->ad_code_3 = Yii::$app->settings->get('ad_code_3', '');
